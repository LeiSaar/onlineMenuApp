...
function displayMenu(menu){
  let itemHtml = "";
  menu.forEach((item) => {
    itemHtml += `<article class="menu-item">
  ...
  sectionCenter.innerHTML = itemHtml;
}
...
let btnHtml = "";
uniqueCategories.forEach((btnCategory)=>{
  btnHtml += `<button class="filter-btn  btn" type="button" data-id=${btnCategory}>${btnCategory}</button>`;
});
